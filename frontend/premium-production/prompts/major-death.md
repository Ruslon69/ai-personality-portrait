...
cardId: major-death
canonicalName: Death
promptId: premium-tarot-prompts-v1:major-death
...
RIDER–WAITE SYMBOLIC IDENTITY: Create a semantically faithful Rider–Waite–Smith-inspired interpretation. Preserve these recognizable identity anchors: skeletal rider; white horse; black banner with white rose; fallen crowned figure; bishop; child and maiden; river and two towers; sunrise on horizon.

MAIN SUBJECT: An armored skeleton rides a white horse through figures responding to irreversible transformation.

POSE AND COMPOSITION: An armored skeleton rides a white horse through figures responding to irreversible transformation.

MANDATORY OBJECTS: skeleton; armor; white horse; black banner; white rose; fallen ruler; bishop; child; maiden; river; towers; sunrise. Preserve exact canonical counts and relationships.

EMOTIONAL TONE: solemn transformation with distant renewal. Elegant, mystical, solemn, luxurious, tactile and timeless; dark fantasy atmosphere without horror spectacle.

FOREGROUND: Keep every canonical near-field figure, object, and suit symbol unobscured.

MIDGROUND: An armored skeleton rides a white horse through figures responding to irreversible transformation.
...
- Do not weaken or replace the card-specific emotional identity: solemn transformation with distant renewal.
...
- [ ] noForbiddenContent
- [ ] canonicalIdentityObvious
- [ ] styleMatchesPilotSet
- [ ] cropSafeAtSevenByTwelve
- [ ] noBakedText
- [ ] noBakedFrame
- [ ] canonicalOrientationUpright
- [ ] reviewerExplicitApproval

Scores use the 1–5 rubric in `premium-production/review-rubric.json`; approval requires at least 4 in every category plus explicit human approval.
